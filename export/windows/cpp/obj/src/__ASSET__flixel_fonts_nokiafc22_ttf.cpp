...
HX_DEFINE_STACK_FRAME(_hx_pos_8c395429170d5493_675_new,"__ASSET__flixel_fonts_nokiafc22_ttf","new",0x22f03f2a,"__ASSET__flixel_fonts_nokiafc22_ttf.new","DefaultAssetLibrary.hx",675,0x0fc48912)
...
::String filename = __o_filename.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_8c395429170d5493_675_new)
HXDLIN( 675)		super::__construct(filename,style,type);
            	}
