...
HXDLIN( 245)			_hx_tmp(((_hx_tmp1 - ::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_width(this->prevButton)) - (int)2));
HXLINE( 246)			::flixel::IFlxSprite_obj::set_y(this->prevButton,this->prevButtonOffset->y);
HXLINE( 247)			 ::Dynamic _hx_tmp2 = this->nextButton->__Field(HX_("set_x",5b,9b,2f,7a), hx::paccDynamic);
HXDLIN( 247)			Float _hx_tmp3 = this->nextButtonOffset->x;
HXDLIN( 247)			_hx_tmp2(((_hx_tmp3 + this->get_width()) + (int)2));
...
HXLINE( 251)			 ::Dynamic _hx_tmp4 = this->prevButton->__Field(HX_("set_y",5c,9b,2f,7a), hx::paccDynamic);
HXDLIN( 251)			Float _hx_tmp5 = this->prevButtonOffset->y;
HXDLIN( 251)			_hx_tmp4(((_hx_tmp5 - ::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_height(this->prevButton)) - (int)2));
HXLINE( 252)			::flixel::IFlxSprite_obj::set_x(this->nextButton,this->nextButtonOffset->x);
HXLINE( 253)			 ::Dynamic _hx_tmp6 = this->nextButton->__Field(HX_("set_y",5c,9b,2f,7a), hx::paccDynamic);
HXDLIN( 253)			Float _hx_tmp7 = this->nextButtonOffset->y;
HXDLIN( 253)			_hx_tmp6(((_hx_tmp7 + this->get_height()) + (int)2));
            		}
HXLINE( 256)		 ::Dynamic _hx_tmp8 = this->prevButton->__Field(HX_("set_x",5b,9b,2f,7a), hx::paccDynamic);
HXDLIN( 256)		_hx_tmp8(::Std_obj::_hx_int(( (Float)(this->prevButton->__Field(HX_("x",78,00,00,00),hx::paccDynamic)) )));
HXLINE( 257)		 ::Dynamic _hx_tmp9 = this->prevButton->__Field(HX_("set_y",5c,9b,2f,7a), hx::paccDynamic);
HXDLIN( 257)		_hx_tmp9(::Std_obj::_hx_int(( (Float)(this->prevButton->__Field(HX_("y",79,00,00,00),hx::paccDynamic)) )));
HXLINE( 258)		 ::Dynamic _hx_tmp10 = this->nextButton->__Field(HX_("set_x",5b,9b,2f,7a), hx::paccDynamic);
HXDLIN( 258)		_hx_tmp10(::Std_obj::_hx_int(( (Float)(this->nextButton->__Field(HX_("x",78,00,00,00),hx::paccDynamic)) )));
HXLINE( 259)		 ::Dynamic _hx_tmp11 = this->nextButton->__Field(HX_("set_y",5c,9b,2f,7a), hx::paccDynamic);
HXDLIN( 259)		_hx_tmp11(::Std_obj::_hx_int(( (Float)(this->nextButton->__Field(HX_("y",79,00,00,00),hx::paccDynamic)) )));
