...
::util::mechanica::LocomotionStatus_obj::__register();
::util::mechanica::EquipType_obj::__register();
...
::cdb::ColumnType_obj::__register();
::ValueType_obj::__register();
::PartType_obj::__register();
...
::flixel::addons::ui::FlxUIColorSwatch_obj::__register();
...
::dat::_Data::CatDataKind_Impl__obj::__register();
::dat::_Data::CatData_partType_Impl__obj::__register();
::dat::_Data::EquipKind_Impl__obj::__register();
::dat::_Data::ThrusterKind_Impl__obj::__register();
::dat::_Data::LegsKind_Impl__obj::__register();
::dat::_Data::CarrierUnitsKind_Impl__obj::__register();
::dat::_Data::CoreKind_Impl__obj::__register();
::dat::_Data::HeadKind_Impl__obj::__register();
::dat::_Data::PartKind_Impl__obj::__register();
::dat::_Data::Part_make_Impl__obj::__register();
::cdb::_Data::TileMode_Impl__obj::__register();
::Xml_obj::__register();
...
::util::mechanica::FirearmUnit_obj::__register();
::util::mechanica::EquipmentUnit_obj::__register();
::util::mechanica::ThrusterUnit_obj::__register();
::util::mechanica::LegUnits_obj::__register();
::util::mechanica::ArmUnits_obj::__register();
::util::mechanica::CarrierUnit_obj::__register();
::util::mechanica::CoreUnit_obj::__register();
::util::mechanica::HeadUnit_obj::__register();
::util::mechanica::Part_obj::__register();
::util::mechanica::IPart_obj::__register();
::util::mechanica::Mechanica_obj::__register();
::util::mechanica::MechGroup_obj::__register();
...
::states::DemoState_obj::__register();
::states::BuildSchematicState_obj::__register();
...
::flixel::addons::ui::SwatchData_obj::__register();
...
::dat::Data_obj::__register();
::dat::_Data::CatData_Impl__obj::__register();
::dat::_Data::Equip_Impl__obj::__register();
::dat::_Data::Thruster_Impl__obj::__register();
::dat::_Data::Legs_Impl__obj::__register();
::dat::_Data::CarrierUnits_Impl__obj::__register();
::dat::_Data::Core_Impl__obj::__register();
::dat::_Data::Head_Impl__obj::__register();
::dat::_Data::Part_Impl__obj::__register();
::cpp::vm::Thread_obj::__register();
::cpp::vm::Mutex_obj::__register();
::cdb::IndexId_obj::__register();
::cdb::Index_obj::__register();
::cdb::_Types::LevelPropsAccess_Impl__obj::__register();
::cdb::_Types::TileLayerData_Impl__obj::__register();
::cdb::_Types::Layer_Impl__obj::__register();
::cdb::_Types::Flags_Impl__obj::__register();
::cdb::_Types::ArrayRead_Impl__obj::__register();
::cdb::_Types::FlagsIterator_obj::__register();
::cdb::_Types::ArrayIterator_obj::__register();
::cdb::Parser_obj::__register();
::cdb::Lz4Reader_obj::__register();
::Type_obj::__register();
...
::util::mechanica::LocomotionStatus_obj::__boot();
::util::mechanica::EquipType_obj::__boot();
...
::Xml_obj::__boot();
::cdb::_Data::TileMode_Impl__obj::__boot();
::dat::_Data::Part_make_Impl__obj::__boot();
::dat::_Data::PartKind_Impl__obj::__boot();
::dat::_Data::HeadKind_Impl__obj::__boot();
::dat::_Data::CoreKind_Impl__obj::__boot();
::dat::_Data::CarrierUnitsKind_Impl__obj::__boot();
::dat::_Data::LegsKind_Impl__obj::__boot();
::dat::_Data::ThrusterKind_Impl__obj::__boot();
::dat::_Data::EquipKind_Impl__obj::__boot();
::dat::_Data::CatData_partType_Impl__obj::__boot();
::dat::_Data::CatDataKind_Impl__obj::__boot();
...
::flixel::addons::ui::FlxUIColorSwatch_obj::__boot();
