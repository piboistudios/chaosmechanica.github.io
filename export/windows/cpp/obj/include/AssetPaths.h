...
class HXCPP_CLASS_ATTRIBUTES AssetPaths_obj : public hx::Object
{
	...
	public:
		...
		static ::String DemoZone__oel;
		static ::String DemoZone2__oel;
		static ::String DemoZone2__oep;
		static ::String test__cdb;
		static ::String TestZone__oel;
		static ::String TestZone__oep;
		static ::String test__ase;
		static ::String test__png;
		static ::String shell__png;
		static ::String demozone__ase;
		static ::String demozone__png;
		static ::String images_go_here__txt;
		static ::String blank__ase;
		static ::String blank__png;
		static ::String arms__png;
		static ::String core__png;
		static ::String flare__png;
		static ::String flaret__png;
		static ::String head__png;
		static ::String legs__png;
		static ::String pistol__png;
		static ::String thruster__png;
		static ::String music_goes_here__txt;
		static ::String sounds_go_here__txt;
		static ::String build_schematic__xml;
		static ::String hangar__xml;
		static ::String main_menu__xml;
};
